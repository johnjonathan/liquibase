...
//            return val.toString();
    ...
    protected boolean canCreateChangeLogTable() throws DatabaseException {
        return ((TRChangeLogHistoryService) ChangeLogHistoryServiceFactory.getInstance().getChangeLogService(this)).canCreateChangeLogTable();
    }
...
//        schemaName = catalogAndSchema.getSchemaName();
    ...
    public void execute(final SqlStatement[] statements, final List<SqlVisitor> sqlVisitors) throws LiquibaseException {
        for (SqlStatement statement : statements) {
            ...
            LogFactory.getInstance().getLog().debug("Executing Statement: " + statement.getClass().getName());
